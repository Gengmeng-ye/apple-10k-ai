...
@media(max-width:600px){
    ...
    .st-key-prompt_suggestions div[data-testid="stButton"] button{display:flex!important;align-items:center!important;justify-content:center!important}
    .st-key-prompt_suggestions div[data-testid="stButton"] button [data-testid="stMarkdownContainer"]{display:flex!important;align-items:center!important;justify-content:center!important;min-height:0!important;height:auto!important;margin:0!important;padding:0!important}
    .st-key-prompt_suggestions div[data-testid="stButton"] button p{margin:0!important;padding:0!important;font-size:.56rem!important;line-height:1!important;white-space:nowrap!important}

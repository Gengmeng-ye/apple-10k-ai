...
/* Keep a small visual gap after the desktop risk selectbox without the large Streamlit default gap. */
@media(min-width:601px){.risk-detail{position:relative;top:-.65rem;margin-bottom:-.65rem}}

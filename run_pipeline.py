...
from src.extract_risk_factors import main as extract_risk_factors
from src.load_warehouse import main as load_warehouse
from src.model_risk_topics import main as model_risk_topics
...
def main() -> None:
    ...
    print("\nStep 3: Validating financial data...")
    validate_data()

    print("\nStep 4: Extracting Risk Factors...")
    extract_risk_factors()

    print("\nStep 5: Modeling risk topics...")
    model_risk_topics()

...
def load_filing_text() -> str:
    """Load the 10-K HTML and convert it to plain text."""
...
def extract_risk_factors(text: str) -> str:
    ...
    end_match = re.search(END_PATTERN, remaining_text,flags=re.IGNORECASE,)

    if end_match is None:
        raise ValueError("Could not find the end of the Risk Factors section.")
